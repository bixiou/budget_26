...
J'estime pour chaque mesure \texttt{budget} une régression OLS du soutien (variable binaire : convenable ou souhaitable~= 1) en fonction du vote déclaré, du revenu, de l'âge, du genre et du niveau de diplôme (estimations pondérées). Les figures~\ref{fig:notes_groupes_budget} et~\ref{fig:notes_groupes_effect_program} présentent le niveau de soutien moyen par groupe électoral pour les deux questions.
