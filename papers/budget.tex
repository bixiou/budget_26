...
Les mesures de \texttt{budget} ont été sélectionnées pour la plupart à partir de l'\href{https://claude.ai/public/artifacts/74cd0701-a4f0-499e-a409-cae1da524ee4}{outil du CAE} et pour les autres à partir de la \href{https://laplateformeprogressiste.org/wp-content/uploads/2025/12/20251210_Resultats-par-mesure-1.pdf}{Plateforme Progressiste}. Souvent, j'ai rassemblé plusieurs mesures en une seule. Le chiffrage d'une mesure provient de la source utilisée, qui le reprend elle-même de rapports officiels (Cour des Comptes, HCFP, IPP, etc.). Plus de détails sont disponibles sur demande.
