...
En effet, la consigne de la Revue d'Économie Politique est un abstract d'environ 200 mots, le mien en faisait 270. J'ai coupé plusieurs phrases dans l'abstract et arrive désormais à 204. Je continue à présenter les résultats plutôt que la question de recherche, car ça me semble plus informatif pour les lecteurs pressés. 
...
Il m'a semblé que les élections européennes reflétaient mieux l'affiliation partisane que les législatives car celles-ci sont sujettes au vote utile et à des dynamiques locales particulières. Notez que la variable utilisée n'est pas le \textit{vote} mais \textit{vote ou affinité}~: pour les abstentionnistes, j'utilise le parti dont ils se sentent le plus proches (cf. note du Tableau 1). 

\bigskip
\noindent\textbf{9.} \textit{Sur le tableau~1 je m'attends également à un commentaire sur l'extrême droite.}

Je ne comprends pas bien quel commentaire est attendu. S'il y a un groupe d'électeurs qui de distinguent en termes de représentativité, c'est celui des \textit{Républicains}. Les sympathisants du RN sont correctement représentés dans l'échantillon, je ne saisis pas bien ce qui manque. 

\bigskip
\noindent\textbf{10.} \textit{Coquilles~: p.1 NBP~1 «~Antoine~» $\Rightarrow$ Antonin~; p.2 «~à gauche.2~» NBP avant le point.}

Corrections effectuées dans le manuscrit.

\bigskip
\noindent Je remercie à nouveau le rapporteur pour la qualité et la précision de son rapport. Ses remarques m'ont conduit à préciser le cadre d'interprétation, à mieux documenter la méthodologie et à circonscrire la portée de certaines conclusions~; l'article s'en trouve sensiblement amélioré. J'espère que cette version révisée répondra à ses attentes, et je reste bien entendu à sa disposition pour toute précision complémentaire.
...
\bigskip
\noindent\textbf{0.} \textit{Cet article est très intéressant. Il s'intéresse à une question importante. La méthodologie est claire. L'article est bien rédigé. Les résultats sont informatifs pour la politique française. Cependant, il ne s'agit pas, selon moi, d'un article de recherche. Sa contribution scientifique n'est pas apparente. Cela n'enlève rien à la qualité de l'article ou à son intérêt.}

Je remercie le rapporteur pour sa lecture attentive et pour ses appréciations encourageantes sur l'importance de la question traitée, la clarté de la méthodologie et l'utilité des résultats pour le débat public français. Je prends acte de sa réserve quant à la contribution scientifique de l'article, et j'espère que les compléments apportés dans cette révision -- en particulier les tests de robustesse détaillés ci-dessous -- en renforceront la portée. Je réponds ci-dessous à chacun de ses commentaires, en indiquant les modifications apportées au manuscrit.
...
Je remercie le rapporteur pour ce commentaire, qui m'a conduit à deux modifications. D'une part, l'hypothèse est désormais explicitée là où la distance est définie (Section~4)~: le codage «~traite comme cardinales des évaluations qui ne sont qu'ordinales~: il suppose que passer d'\textit{inacceptable} à \textit{supportable} représente le même écart que passer de \textit{supportable} à \textit{convenable}~».

D'autre part, j'ai reproduit l'analyse des distances en regroupant les évaluations \texttt{budget} en deux catégories seulement, selon les deux seuils naturels~: \textit{convenable} ou \textit{souhaitable} vs. \textit{supportable} ou \textit{inacceptable}, et \textit{acceptable} (c'est-à-dire non-\textit{inacceptable}) vs. \textit{inacceptable}. J'ai également testé une variante où les évaluations \texttt{programme} sont elles aussi binarisées. Ces regroupements ne modifient pas l'essentiel de l'analyse~: la reconstitution du spectre politique à partir des distances entre électorats (les électeurs PS et LÉ plus proches de LFI que du Centre-droit, le Centre-droit plus proche de LR que du PS ou de LÉ, LR plus proche du Centre-droit que de l'extrême-droite) est confirmée, de même que le fait que les électeurs LFI sont les plus éloignés de l'ensemble de l'électorat, et que les distances \textit{au sein} des groupes restent supérieures aux distances \textit{entre} groupes.

Une observation est en revanche fragilisée~: les électeurs du RN ne sont plus les plus proches de l'ensemble de l'électorat, cette place revenant au Centre-droit -- mais les cinq partis autres que LFI deviennent alors quasiment équidistants de l'ensemble de l'électorat (de 33,2 à 33,5), de sorte que ce classement n'est plus discriminant. Une seconde l'est marginalement~: avec le seuil \textit{acceptable} vs. \textit{inacceptable}, les électeurs PS sont très légèrement plus proches du Centre-droit (31,8) que de LFI (32,2). La note de bas de page consacrée à la robustesse a été réécrite pour rapporter précisément ces résultats, ainsi que ceux des trois autres définitions alternatives de la distance déjà testées.
...
L'absence d'analyse des abstentionnistes se justifie par quatre raisons. Premièrement, la variable utilisée dans l'analyse est \textit{vote ou affinité}, c'est-à-dire le vote réel ou hypothétique aux européennes de 2024 (en cas d'abstention, on utilise le parti dont le répondant se sent le plus proche), qui fait rentrer les abstentionnistes dans les trois principaux blocs politiques. Deuxièmement, comme vous le soulignez, bon nombre d'abstentionnistes aux européennes votent aux élections nationales~; ainsi, une analyse portant sur les abstentionnistes aux européennes ne saurait se transposer sur les abstentionnistes aux élections nationales. Troisièmement, il y a un biais connu à sous-reporter l'abstention dans les enquêtes d'opinion (e.g., Sciarini \& Goldberg, 2016), qui pourrait biaiser une analyse des abstentionnistes déclarés. Quatrièmement, il serait lourd de dupliquer l'analyse en utilisant la variable \textit{vote} plutôt que \textit{vote ou affinité}. Je préfère donc m'en tenir à l'analyse actuelle, qui intègre les abstentionnistes en fonction de leur affinité partisane.

\subparagraph*{Autres commentaires}

\bigskip
\noindent\textbf{3.} \textit{Les électeurs d'extrême droite constituent le groupe majoritaire après exclusion des abstentionnistes. Il est donc mécanique que leurs attitudes soient celles qui sont les plus proches de celles de l'ensemble des électeurs (page~12).}

Tout à fait. J'ai enlevé la formulation «~\textit{De façon intéressante}~». Notez que les tests de robustesses effectués ci-dessus ont révélé que cette proximité n'est pas si robuste, ce que j'ai précisé entre parenthèses. % par «~\textit{Conformément à leur poids électoral}~» pour rendre compte du fait que cette force mécanique n'est pas surprenante.

\bigskip
\noindent\textbf{4.} \textit{Je n'ai pas du tout compris l'explication des 50~\%, 32~\% et 68~\% en page~7.}

J'ai rallongé l'explication, en espérant la clarifier. J'écris désormais~: «~\textit{Les caractéristiques sociodémographiques expliquent 13\,\% de la variance, un chiffre standard pour les attitudes politiques. Pour interpréter ce chiffre, prenons un cas simplifié, où 50\,\% des répondants sont \textit{Pour} une mesure et autant \textit{Contre}. Imaginons que le genre soit la seule caractéristique qui prédit cette attitude~: 68\,\% des femmes sont \textit{Pour} vs. 32\,\% des hommes. En d'autres termes, on a une chance sur deux de correctement prédire l'attitude quand on ne sait rien de la personne, et 68\,\% de chances lorsqu'on connaît son genre. Dans ce cas, un rapide calcul montre que 13\,\% de la variance est expliqué par les caractéristiques sociodémographiques} [note de bas de page: \textit{En effet, on a 36\,\% de chances supplémentaires de faire une prédiction correcte en connaissant le genre. Cela signifie que le genre explique 36\,\% de l'écart-type, soit une part $0,36^2=0,13$ de la variance}.].~»

\bigskip
\noindent\textbf{5.} \textit{La note de bas de page 14 (page~18) n'est pas claire.}

J'ai reformulé cette note de bas de page, en espérant la clarifier.

\bigskip
\noindent\textbf{6.} \textit{La section~6 est très intéressante~!}

Merci~!

\bigskip
\noindent Je remercie à nouveau le rapporteur pour sa lecture attentive et pour ses commentaires, qui m'ont conduit à expliciter mes hypothèses de travail, à en éprouver la robustesse et à clarifier plusieurs passages du manuscrit. J'espère que cette version révisée sera convaincante, et je reste à sa disposition pour toute précision complémentaire.
