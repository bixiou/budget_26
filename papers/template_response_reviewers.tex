...
\reponse{Je remercie le rapporteur pour ce commentaire, qui m'a conduit à deux modifications. D'une part, l'hypothèse est désormais explicitée là où la distance est définie (Section~4)~: le codage «~traite comme cardinales des évaluations qui ne sont qu'ordinales~: il suppose que passer d'\textit{inacceptable} à \textit{supportable} représente le même écart que passer de \textit{supportable} à \textit{convenable}~».
